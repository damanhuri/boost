package com.boost.iv.voucherpool.error;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public  ResponseEntity<Object> handleConstraint(ConstraintViolationException ex, 
	    ...
	    ApiError apiError = 
	      new ApiError(HttpStatus.BAD_REQUEST, request.getDescription(false), "Unique constraint violation exception!");
	    return new ResponseEntity<Object>(
	      apiError, new HttpHeaders(), apiError.getStatus());
    }
	...
	public ResponseEntity<Object> handleUniqueContraintViolation(
			org.hibernate.exception.ConstraintViolationException ex, WebRequest request) {
	    String error = "Unique contraint violated!";
